...
async function seed() {
  ...
  const databaseUrl =
    ...
    "postgresql://postgres.ytotaiiqfimhlfllasfk:7kVIzuGsNQITHLrn@aws-1-eu-west-1.pooler.supabase.com:5432/postgres";

  if (!databaseUrl) {
    console.error("DATABASE_URL not set. Using Supabase for seeding.");

    const supabaseUrl =
      process.env.SUPABASE_URL || "https://ytotaiiqfimhlfllasfk.supabase.co";
    const supabaseKey =
      process.env.SUPABASE_SERVICE_KEY ||
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl0b3RhaWlxZmltaGxmbGxhc2ZrIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3Mzc2OTA3OCwiZXhwIjoyMDg5MzQ1MDc4fQ.FmNcoWhB2472_ZSRiLnf8uDae23ZyGfHT5b6X7xoORI";
    ...
    console.log("\nLogin credentials:");
    console.log(
      "Email: super_admin@example.com | Password: 123456 | Role: super_admin",
    );
    console.log(
      "Email: compliance@example.com | Password: 123456 | Role: compliance",
    );
    console.log(
      "Email: support@example.com | Password: 123456 | Role: support",
    );
    console.log(
      "Email: marketing@example.com | Password: 123456 | Role: marketing",
    );
    console.log(
      "Email: developer@example.com | Password: 123456 | Role: developer",
    );
